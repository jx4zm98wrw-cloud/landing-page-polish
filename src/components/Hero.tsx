      ...
      <div className="container-custom">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fade-in">
            <h1 className="text-5xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight text-balance">
              Đăng ký <span className="text-primary">Bảo hộ Nhãn hiệu</span>
              <br />
              Toàn diện
            </h1>

            <p className="text-xl md:text-xl lg:text-2xl text-muted-foreground">
